...
class WGAN(keras.models.Model):
    ...
    def build_discriminator(self) -> Sequential:
        ...
        # for units in [256, 256, 256, 256, 256]:
        # for units in [512, 512, 512, 512, 512]:
        for units in [512, 512, 512, 512, 512, 512, 512, 512]:
...
if __name__ == "__main__":
    epochs, batch_size, freq = 200000, 5000, 1
    ...
    monitor = GANMonitor(train[:200000], feature_names, frequency=freq, sclr=sclr)
    callbacks= [ monitor ]
